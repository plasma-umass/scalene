...
|               |     |        |                    | |  |
| `scalene` _(CPU only)_ | 6.98s | **1.04x** | :heavy_check_mark: | :heavy_check_mark: | **both**  | :heavy_check_mark: |  | :heavy_check_mark: |
| `scalene` _(CPU + memory)_ | 7.68s | **1.14x** | :heavy_check_mark: | :heavy_check_mark: | **both** | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
