...
class Scalene():
    ...
    malloc_sampling_rate          = 1 * 1024 * 1024  # we get signals after this many bytes are allocated.
                                                      # NB: MUST BE IN SYNC WITH include/sampleheap.hpp!
    free_sampling_rate            = 1 * 1024 * 1024  # as above, for frees.
    ...
    def malloc_signal_handler(_, frame):
        ...
        if Scalene.current_footprint > Scalene.max_footprint:
            ...
            # print(fname + " " + str(frame.f_lineno) + " = " + str(Scalene.max_footprint))
        return
