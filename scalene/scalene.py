...
class Scalene():
    ...
    malloc_sampling_rate          = 256 * 1024 * 1024    # we get signals after this many bytes are allocated/freed.
                                                   # NB: MUST BE IN SYNC WITH include/sampleheap.hpp!
    free_sampling_rate            = 256 * 1024 * 1024
                    ...
                    for line_no, line in enumerate(source_file, 1):
                        ...
                        if did_sample_memory:
                            print("%6d\t | %9s| %9s| %11s | %s" %
                                  (line_no, n_cpu_percent_python_str, n_cpu_percent_c_str, n_growth_mb_str, line), file=out)
                        else:
                            print("%6d\t | %9s| %9s| %s" %
