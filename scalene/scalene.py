...
class Scalene():
    ...
    memory_malloc_samples         = defaultdict(lambda: defaultdict(int))  # free samples for each location in the program
    ...
    memory_max_samples            = defaultdict(lambda: defaultdict(int))  # malloc samples for each location in the program
    total_max_samples             = 0
