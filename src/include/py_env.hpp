...
public:
    PyStringPtrList(PyObject* list_wrapper, PyObject* base_path, bool profile_all_b) {
...
static void set_py_string_ptr_list(PyObject* p, PyObject* base_path, bool trace_all) {
